        ...
        <div class="w-full md:w-4/5 mx-auto rounded border-[1px] p-4 md:px-8 mt-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="">
                    ...
                    <select id="section_id_export" class="custom-input-borderless text-sm md:text-base px-4">
            ...
            <form action="{{ route('sections.export.post') }}" method="post" onsubmit="return validateBeforeSubmit(event)">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 border rounded p-5 mt-3 bg-blue-50">
