...
@section('page-content')
    ...
    <div class="flex items-center justify-between flex-wrap gap-3 mb-6">
        <div>
            <h1 class="text-xl md:text-2xl font-bold text-gray-800">Add New Lecture Timing</h1>
            <div class="bread-crumb mt-1">
                ...
                <div>/</div>
                <span class="text-gray-500">New Timing</span>
            </div>
        </div>
    </div>
    ...
    <div class="md:w-11/12 lg:w-3/4 xl:w-2/3 mx-auto space-y-5">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            <form action="{{ route('lecture-timings.store') }}"
                ...
                <div class="px-6 py-5">
                    ...
                    <input type="number" name="lecture_no" value="{{ old('lecture_no') }}"
                ...
                <div class="px-6 py-4 bg-gray-50/60 rounded-b-2xl flex flex-wrap-reverse items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <button type="submit"
                            ...
                            <i class="ri-save-line"></i> Create Timing
                        </button>
                    </div>
                </div>
            </form>
