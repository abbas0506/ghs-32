        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 py-2 mb-2">
            <div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-black text-slate-800 leading-none mb-1">New Allocation</h1>
                        <p class="text-slate-400 text-xs font-medium italic">Assign a subject and teacher for a specific period</p>
                    </div>
                </div>
            </div>
            <a href="{{ route('section.lecture.schedule.index', [0, 0]) }}" class="flex items-center gap-2 px-4 py-2 bg-white text-slate-600 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-50 border border-slate-200 transition-all shadow-sm">
            ...
            <form action="{{ route('section.lecture.schedule.store', [$section, $lecture_no]) }}" method='post' class="bg-white border border-slate-100 rounded-[2rem] shadow-xl shadow-slate-200/40 overflow-hidden" onsubmit="return window.validateForm(event)">
                    ...
                    <div class="flex flex-wrap lg:flex-nowrap items-center gap-4 md:gap-6 relative z-10 w-full">
                        <div class="flex items-center gap-4 min-w-[200px]">
                            ...
                            <div class="overflow-hidden">
                                <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Target Class</p>
                                <h2 class="text-xl md:text-2xl font-black text-slate-800 truncate">{{ $section->name }}</h2>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 bg-white px-4 py-2.5 md:bg-transparent md:px-0 md:py-0 border border-slate-100 md:border-none rounded-xl ml-auto md:ml-0 shadow-sm md:shadow-none shrink-0">
                            ...
                            <div>
                                <p class="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-0.5">Time Slot</p>
                                <h3 class="text-sm font-black text-slate-700 whitespace-nowrap">Period {{ $lecture_no }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-5 md:p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="group relative bg-white border-2 border-slate-100 rounded-[1.5rem] p-6 hover:border-teal-100 transition-colors">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    <h3 class="text-sm font-black text-slate-800">Assign Subject</h3>
                        ...
                        <div class="group relative bg-white border-2 border-slate-100 rounded-[1.5rem] p-6 hover:border-teal-100 transition-colors">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    <h3 class="text-sm font-black text-slate-800">Assign Teacher</h3>
                    ...
                    <div class="bg-slate-50 border border-slate-100 rounded-[1.5rem] p-5 md:p-8 text-center relative overflow-hidden">
                        <label class="block text-sm font-black text-slate-800 mb-1">Active Days</label>
                        ...
                        <div class="flex flex-wrap justify-center gap-3 md:gap-4 relative z-10">
                            ...
                            @foreach ($days as $i => $day)
                                <div class="day-circle w-12 h-12 md:w-14 md:h-14 text-sm font-black bg-white border border-slate-200 text-slate-400 flex items-center justify-center rounded-[1rem] cursor-pointer select-none transition-all hover:-translate-y-1 hover:shadow-md hover:border-teal-200"
                ...
                <div class="bg-slate-50 border-t border-slate-100 -mx-5 md:-mx-8 -mb-5 md:-mb-8 p-5 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <button type="submit" class="w-full md:w-auto flex items-center justify-center gap-2 px-8 py-3.5 bg-teal-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-teal-700 hover:shadow-xl hover:shadow-teal-100 transition-all group">
