        ...
        <div class="flex items-center gap-4 py-2">
            <div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-black text-slate-800 leading-none mb-1">New Individual Test</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-[2rem] border border-slate-100 p-8 shadow-sm">
                <form action="{{ route('class-tests.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">4. Select Subject & Class</label>
            ...
            <div class="hidden lg:block space-y-6">
                <div class="bg-teal-600 rounded-[2rem] p-8 text-white relative overflow-hidden">
                    <div class="relative z-10">
                        <h3 class="text-xl font-black mb-4 leading-tight">Create your own assessments effortlessly.</h3>
