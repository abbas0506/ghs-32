...
@section('page-content')
    ...
    <div class="mb-6">
        ...
        <div class="bread-crumb mt-1">
            ...
            <div>/</div>
            <a href="{{ route('lessons.index', ['grade_id' => $grade?->id]) }}" class="text-teal-600 hover:underline">
                {{ $grade?->name }}
            </a>
            <div>/</div>
                ...
                <div>
                    ...
                    <form action="{{ route('lessons.store') }}" method="post">
                        ...
                        <div class="flex justify-center my-5">
                            ...
                            <button type="submit"
                                class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-500 to-green-500 text-white text-sm font-semibold rounded-xl shadow hover:from-teal-600 hover:to-green-600 transition"><i
